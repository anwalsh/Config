...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER6] = LAYOUT_planck_grid(KC_NO,KC_NO,LCTL(LSFT(KC_RIGHT)),LCTL(LSFT(KC_RIGHT)),KC_NO,KC_NO,LCTL(KC_C),KC_NO,KC_HOME,KC_NO,LCTL(KC_V),KC_BSPACE,KC_NO,KC_END,KC_NO,KC_NO,KC_NO,KC_PGDOWN,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_TRANSPARENT,KC_NO,KC_BSPACE,KC_NO,KC_NO,LCTL(KC_LEFT),KC_NO,KC_NO,LCTL(LGUI(KC_LEFT)),LCTL(LGUI(KC_RIGHT)),KC_NO,KC_ENTER,KC_NO,KC_LCTRL,KC_LALT,OSM(MOD_LGUI),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO),
