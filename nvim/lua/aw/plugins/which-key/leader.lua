...
wk.register({
    ...
    ["<leader>"] = {
        ...
        ["f"] = {
            ...
            h = { "<cmd>lua require('aw.plugins.telescope').find_hidden_files()<cr>", "Find Hidden Files" },
        ...
        ["g"] = {
            name = "+git",
            b = { "<cmd>lua require('aw.plugins.telescope').git_branches()<cr>", "Git Branches" },
        ...
        ["o"] = {
            ...
            q = { "<cmd>Trouble qflist<cr>", "Open Quickfix" },
        },
        ["p"] = {
            name = "+project",
            f = { "<cmd>lua require('aw.plugins.telescope').project_search()<cr>", "Open Project File" },
        ...
        ["s"] = {
            ...
            n = { "<cmd>lua require('aw.plugins.telescope').search_all_files()<cr>", "Search File Names in Context" },
        ...
        [","] = {
            ...
            n = { "<cmd>lua require('aw.plugins.telescope').edit_nvim()<cr>", "Edit Nvim Config" },
            d = { "<cmd>lua require('aw.plugins.telescope').edit_config()<cr>", "Edit Config Files" },
            s = {
        ...
        ["x"] = {
            ...
            X = { "<cmd>Trouble diagnostics toggle filter.buf=0<cr>", "Trouble Buffer Diagnostics" },
            s = { "<cmd>Trouble symbols toggle focus=true<cr>", "Trouble Symbols" },
            l = { "<cmd>Trouble lsp toggle focus=true win.position=right<cr>", "LSP Def/Ref" },
            t = { "<cmd>TodoTrouble<cr>", "Todo Trouble" },
            T = { "<cmd>TodoTelescope<cr>", "Todo Telescope" },
            L = { "<cmd>Trouble loclist toggle<cr>", "Open Location List" },
            q = { "<cmd>Trouble qflist toggle<cr>", "Open Quickfix List" },
        },
