...
wk.add({
    ...
    },
    {
        ...
        },
        {
            ...
            {
                { "gM", group = "Merge Conflict" },
                { "gMl", "<cmd>GitConflictListQf<cr>", desc = "List of Conflicts" },
                { "gMo", "<Plug>(git-conflict-ours)", desc = "Choose our change" },
                { "gMt", "<Plug>(git-conflict-theirs)", desc = "Choose their change" },
                { "gMb", "<Plug>(git-conflict-both)", desc = "Choose both changes" },
                { "gMn", "<Plug>(git-conflict-none)", desc = "Choose neither change" },
                { "gM]", "<Plug>(git-conflict-prev-conflict)", desc = "Previous Conflict" },
                { "gM[", "<Plug>(git-conflict-prev-conflict)", desc = "Next Conflict" },
            },
            {
                { "<leader>G", group = "Octo" },
                {
                    { "Gp", group = "+pr" },
                    { "Gpl", "<cmd>Octo pr list<cr>", desc = "List PRs in Current Repository" },
                    { "Gpc", "<cmd>Octo pr changes<cr>", desc = "List Changes on PR" },
                    { "Gpd", "<cmd>Octo pr diff<cr>", desc = "Show PR Diff" },
                    { "GpC", "<cmd>Octo pr checkout<cr>", desc = "Checkout PR" },
                    { "Gpr", "<cmd>Octo pr reload<cr>", desc = "Reload PR" },
                    { "Gpb", "<cmd>Octo pr browser<cr>", desc = "Open PR in Browser" },
                    { "GpR", "<cmd>Octo pr ready<cr>", desc = "Mark Draft PR as Ready for Review" },
                    { "Gpx", "<cmd>Octo pr close<cr>", desc = "Close current PR" },
                    { "Gpu", "<cmd>Octo pr url<cr>", desc = "Copy PR URL" },
                    { "Gpv", "<cmd>Octo pr checks<cr>", desc = "Show PR Readiness Validation" },
                    { "Gpn", "<cmd>Octo pr create<cr>", desc = "Create a PR from the current Branch" },
                },
                {
                    { "Gr", group = "+repo" },
                    { "Grb", "<cmd>Octo repo browser<cr>", desc = "Open repo in browser" },
                    { "Gru", "<cmd>Octo repo url<cr>", desc = "Repo URL" },
                },
                {
                    { "Gt", group = "+threads" },
                    { "Gtr", "<cmd>Octo thread resolve<cr>", desc = "Resolve Thread" },
                    { "Gtu", "<cmd>Octo thread unresolve<cr>", desc = "Unresolve Thread" },
                },
                {
                    { "GR", group = "+review" },
                    { "GRr", "<cmd>Octo review start<cr>", desc = "Start Review" },
                    { "GRs", "<cmd>Octo review submit<cr>", desc = "Submit Review" },
                    { "GRR", "<cmd>Octo review resume<cr>", desc = "Resume Review" },
                    { "GRD", "<cmd>Octo review discard<cr>", desc = "Discard Review" },
                    { "GRc", "<cmd>Octo review comments<cr>", desc = "View Review Comments" },
                    { "GRx", "<cmd>Octo review close<cr>", desc = "Close review window" },
                },
                { "<leader>Gs", "<cmd>Octo search<cr>", desc = "Search GH" },
                { "<leader>Gg", "<cmd>Octo gist list<cr>", desc = "List gists" },
                { "<leader>Gi", "<cmd>Octo issue list<cr>", desc = "List Issues in GitHub" },
                { "<leader>G?", "<cmd>Octo actions<cr>", desc = "List Octo Actions" },
            },
