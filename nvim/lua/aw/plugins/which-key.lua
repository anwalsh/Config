-------------------------------------------------------------------------------
-- Which-Key (merged from wk.lua, which.lua, leader.lua)
-------------------------------------------------------------------------------
...
-- Helper references
local ts = _G.aw_telescope or {}

wk.add({
    { "<leader>w", ":w<cr>", hidden = true },
    ...
    { "<leader><leader>", "<Cmd>Legendary<CR>", desc = "Search All Commands" },
    ...
    { "<leader>fh", function() ts.find_hidden_files() end, desc = "Find Hidden Files" },
    ...
    { "<leader>gM]", "<Plug>(git-conflict-next-conflict)", desc = "Next Conflict" },
    { "<leader>gM[", "<Plug>(git-conflict-prev-conflict)", desc = "Previous Conflict" },
    { "<leader>gG", group = "Octo" },
    { "<leader>gGp", group = "+pr" },
    { "<leader>gGpl", "<cmd>Octo pr list<cr>", desc = "List PRs" },
    ...
    { "<leader>gGpR", "<cmd>Octo pr ready<cr>", desc = "Mark Draft PR as Ready" },
    { "<leader>gGpx", "<cmd>Octo pr close<cr>", desc = "Close current PR" },
    { "<leader>gGpu", "<cmd>Octo pr url<cr>", desc = "Copy PR URL" },
    { "<leader>gGpv", "<cmd>Octo pr checks<cr>", desc = "Show PR Checks" },
    { "<leader>gGpn", "<cmd>Octo pr create<cr>", desc = "Create PR" },
    ...
    { "<leader>gGi", "<cmd>Octo issue list<cr>", desc = "List Issues" },
    ...
    { "<leader>gFl", "<cmd>Telescope advanced_git_search search_log_content<cr>", desc = "Search Log Content" },
    { "<leader>gFL", "<cmd>Telescope advanced_git_search diff_commit_line<cr>", desc = "Search Diff Commit Line" },
    { "<leader>gFc", "<cmd>Telescope advanced_git_search diff_commit_file<cr>", desc = "Search Diff Commit File" },
    { "<leader>gFb", "<cmd>Telescope advanced_git_search diff_branch_file<cr>", desc = "Search Diff Branch File" },
    ...
    { "<leader>pf", function() ts.project_search() end, desc = "Open Project File" },
    { "<leader>pp", "<cmd>Telescope project<CR>", desc = "Project Finder" },
    ...
    { "<leader>sn", function() ts.search_all_files() end, desc = "Search File Names in Context" },
    ...
    { "<leader>ss", function() ts.lsp_document_methods() end, desc = "LSP Doc Methods" },
    { "<leader>sS", "<cmd>Telescope lsp_document_symbols<cr>", desc = "LSP Doc Symbols" },
    { "<leader>st", function() ts.search_only_certain_files() end, desc = "Search by file types" },
    ...
    -- Terminal + Zen
    { "<C-`>", "<cmd>ToggleTerm dir=%:p:h<cr>", desc = "Terminal" },
