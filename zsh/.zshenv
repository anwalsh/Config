...
export PATH="$PYENV_BIN:$RUST:$TOOLS:$SBIN:$BIN:$TBIN:$LOCALBIN:$LOCALSBIN:$NPATH\
:$GOROOT:$GOBIN:$GOPATH:$T2PATH:$JAVA_HOME:$ANT_HOME:$ANT_BIN:$FZF:$CODE:$NODEMODS:$N\
:$LOCAL:$KUBECONFIG:$SNAP:$KREW_ROOT:$KREW:$RUST_ENV:$CODE:$PATH"
