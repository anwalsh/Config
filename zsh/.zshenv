...
export POETRY_BIN="$HOME/.local/share/pypoetry/venv/bin"
export PYENV_ROOT="$HOME/.pyenv"
export PYENV_BIN="$PYENV_ROOT/bin"
export BAT_THEME="Dracula"
export VASA_HOME="$HOME/.vasa"
export PATH="$PYENV_BIN:$RUST:$TOOLS:$POETRY_BIN:$SBIN:$BIN:$TBIN:$LOCALBIN:$LOCALSBIN:$NPATH:$GO:$GOBIN:$GOPATH:$T2PATH:$JAVA_HOME:$ANT_HOME:$ANT_BIN:$FZF:$CODE:$NODEMODS:$N:$LOCAL:$KUBECONFIG:$SNAP:$KREW_ROOT:$KREW:$RUST_ENV:$CODE:$PATH:$BAT_THEME:$VASA_HOME:$DOTLOCAL"
